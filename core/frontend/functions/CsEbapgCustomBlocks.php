    ...
    public static function special_discount_offer_box(){
        ...
        ?>
            <div class="special-discount-notification">
                <span class="highlight"> <?php echo isset($settings['offer_msg_blink_text']) ? $settings['offer_msg_blink_text'] : __( 'Special Discount!', 'edd-bitcoin-altcoin-payment-gateway' ); ?></a> <?php _e( 'to see more..', 'edd-bitcoin-altcoin-payment-gateway' ); ?>
            </div>
            <div class="special-discount-box hidden">
                <b><?php
                    echo isset($settings['offer_msg_text']) ? $settings['offer_msg_text'] : __( 'You will get special discount, if you pay with following AltCoins', 'edd-bitcoin-altcoin-payment-gateway' );
                ?></b>
                <ol>
