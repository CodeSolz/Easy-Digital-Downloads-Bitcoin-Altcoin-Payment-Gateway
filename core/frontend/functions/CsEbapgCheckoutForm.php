...
class CsEbapgCheckoutForm {
    ...
    public static function checkout_form(){
        ...
        ?>
            <fieldset id="" class="">
                <legend><?php echo isset($options->block_section_title) ? $options->block_section_title : __( 'Cryptocurrency Payment Information', 'edd-bitcoin-altcoin-payment-gateway' ); ?></legend>
                <p>
                    <label><?php echo isset($options->select_box_lebel) ? $options->select_box_lebel : __( 'Please select coin you want to pay:', 'edd-bitcoin-altcoin-payment-gateway' ); ?></label>
                    <?php echo self::getActiveAltCoinSelect( $options ); ?>
                </p>
                <div class="coin-detail"><!--coin calculation--></div>
    ...
    public static function getActiveAltCoinSelect( $refObj = false ){
        ...
        $lebel = isset( $refObj->select_box_option_lebel ) && !empty($refObj->select_box_option_lebel) ? $refObj->select_box_option_lebel : __( 'Please Select An AltCoin', 'edd-bitcoin-altcoin-payment-gateway' );
