    ...
    public function add_new_coin($args)
    {
        ...
        $fields = array(
            ...
            'cs_add_new[coin_address]' => array(
                ...
                'class'            => "form-control",
                'required'         => true,
                'value'            => empty($coin_addresses) ? '' : \esc_html($coin_addresses[0]),
                ...
                'hidden_div'       => array(
                    'attributes' => array('id' => 'hidden_block', 'class' => "{$hidden_block} more_address_block"),
                    'more_input_fields' => array('item' => 9, 'values' => \esc_html($coin_addresses), 'attributes' => array(
                        'type'             => 'text',
